      ...
      {!isLoadingDone ? (
        ...
        <>
          ...
          <div className="container">
            ...
            <div className="row justify-content-center">
              <div className="col-md-8">
                <p className="mt-5 mb-5">{infoObj["Description"]}</p>
                {props.portfolioURL ===
                "videos-for-uw-madison-memes-for-milk-chugging-teens" ? (
                  <>
                    <div className="text-center">
                      ...
                      <a
                        ...
                        role="button"
                        href={"https://www.facebook.com/groups/175526726305977"}
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        Check Out the UW-Madison Memes for Milk-Chugging Teens
                        Facebook Page
                      </a>
                    </div>
                  </>
          ...
          {infoObj["sections"].map((sectionObj, idx) => (
            <div
              key={idx}
              className={`container-fluid py-3 ${idx % 2 === 0 ? "bg-light" : ""}`}
            >
              <div className="container">
