  ...
  return (
    <>
      <Helmet>
        ...
        />
        <meta property="og:title" content="Let's Connect | Eddie Estevez" />
        <meta
      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-md-12">
            <h3 className="mb-4 contactPageTitle">
              See what I'm up to on social media!
            </h3>
            <div className="wrapper itemBoxes">
              <div className="row mb-5 g-5">
                <ContactItem
                  imgAddr={instagramIcon}
                  imgAlt="Instagram Logo"
                  txtTitle="Instagram"
                  href="https://www.instagram.com/edd1e_estevez/"
                  colClass="col-md-6 col-6"
                />
                <ContactItem
                  imgAddr={linkedInLogo}
                  imgAlt="LinkedIn Logo"
                  txtTitle="LinkedIn"
                  href="https://www.linkedin.com/in/eduardo-estevez-a63193144/"
                  colClass="col-md-6 col-6"
                />
              </div>
              ...
              <div className="row no-gutters bg-light mb-5 rounded">
                      ...
                      <div className="row gy-3">
                        ...
                        <div className="col-md-12">
                          <div className="form-group">
                            <input
                              type="submit"
                              value={`${emailState === EmailState.SENDING ? "Sending" : "Send"}`}
                ...
                <div className="col-md-5 d-flex align-items-stretch">
                  <div
                    id="formImage"
                    className="info-wrap w-100 p-5 img rounded"
                  />
                </div>
              </div>
            </div>
      ...
      return (
        <>
          <div className="alert alert-warning" role="alert">
            ...
            <p>
              You can't send a message if there isn't a message in the first
              place!
            </p>
          </div>
        </>
      ...
      return (
        <>
          <div className="alert alert-warning" role="alert">
            ...
            <p>
              Please wait at least 5 seconds before re-attempting, thank you!
            </p>
          </div>
        </>
      );
      ...
      return (
        <>
          <div className="alert alert-danger" role="alert">
            ...
            <p>
              Sorry, your message wasn't able to be sent! Please try again
              later!
            </p>
          </div>
        </>
