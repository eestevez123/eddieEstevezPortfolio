export const imageCards =  [
    {   
        ...
        desc: "For three years within my college career, I helped run the UW-Madison Facebook meme page called UW-Madison Memes for Milk Chugging teens. Throughout my time as an admin, I made a good amount of memes.",
        href: "uw-madison-memes", 
    },
    {   
        src: require("../../images/myWorkPage/images/lacosecha/box.jpg").default,
        alt: "La Cosecha Tortilla Companny Pictures Logo",
        title: "La Cosecha Tortilla Companny Pictures",
