export const websiteInfo = [
    {   
        ...
        WhatIDid: "I started this React website with the create-react-app toolchain to get me started, and I used Bootstrap as my CSS framework. I took advantage of a lot of features React provides such React hooks, state management, as well as reusable components. I also took advantage of many NPM packages that helped me get a lot of functionality out of the site and to make sure it was search engine optimized.",
        WhatILearned: "This project has placed me in a position where I have built a react web app from scratch (with the help of create-react-app), getting way more familiar with Bootstrap 5 classes, as well as React features such as hooks and state. This project has also taught me the importance of making the app functional despite slow load times, so I implement loading skeletons to take place of content as it loaded. Overall, building out my own personal website was a great refresher on my web development skills. ",
        CarouselImages: [{
            ...
            },
            {
                ...
                label: "Github Repo For This Website",
    ...
    {   
        ...
        CarouselImages: [{
            ...
            },
            {
                ...
                desc: "I hooked up component between the pages to make it perform as if it was a functional website",
    ...
    {   
        ...
        WhatIDid: "This project required me to do research on risk and how it is defined within a company such as Northwestern Mutual. I also made a lot of questions on what a decision maker such as a manger would like to see out of a risk assessment application. I focused on the front-end development of the application while my coworker focused on the backend. The app was built using with a React Front-End while using MongoDB as the database. Python scripts were also used to data scrape risk assessments that were available to use in the form of word documents, excel sheets, etc.  ",
        WhatILearned: "I was not exposed to React before this summer, so it was imperative I quickly learned React and how it functioned. I learned the best way for myself to learn a new technology, which ended up being a mix of following YouTube tutorials, as well as allowing myself to explore “What If I could…” scenarios whenever they would pop up in my head. I also learned about what risk was in the context within a company like Northwestern Mutual and how such a thing could be quantized and aggregated. ",
        CarouselImages: []
    },
    {   
