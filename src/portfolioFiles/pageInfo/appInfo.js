export const appInfo = [
    ...
    {   
        ...
        WhatIDid: "Within the two classes, I dived into multiple projects that I found to be very useful. Here are some of them",
        WhatILearned: "Overall, these classes gave me a better understanding of C code and therefore research management and how compilers might translate what I’m writing to give to the OS.",
        CarouselImages: [{
                src: require("../../images/placeholder.png").default,
                label: "LABEL",
                desc: "DESC"
    ...
    {   
        ...
        WhatIDid: "I used python to implement 5 different projects throughout the semester. Here are they",
        WhatILearned: "This class opened got me more experience with python and the many packages available to implement cool AI related projects.",
        CarouselImages: [{
                src: require("../../images/placeholder.png").default,
                label: "LABEL",
                desc: "DESC"
    ...
    {   
        id: "introduction-to-bioinformatics-via-jupyter-notebooks",
        PageTitle: "Introduction to Bioinformatics via Jupyter Notebooks",
        CoverPic: require("../../images/myWorkPage/cardPics/app/bmi.png").default, 
        Background: "In my senior year (Fall 2020), I took a class called BMI 576: Introduction to Bioinformatics. This class stood as a challenge for me at first, as I only had a tech background without knowing much about the biology that the class dealt with. However, I took this opportunity to learn more about biology to better understand the assignments and projects in the class. ",
        WhatIDid: "I used python within Jupyter Notebooks to solve classic bioinformatic problems. They include the following",
        WhatILearned: "I was more self-aware about my learning style when dealing with unfamiliar topics. I also learned about specific python packages that were imperative for me to use for specific assignments. ",
        CarouselImages: [{
                src: require("../../images/placeholder.png").default,
                label: "LABEL",
                desc: "DESC"
